...
public class SuperUltimatePainting extends JFrame
{
    ...
    {
        new SuperUltimatePainting();
    }
 
    public SuperUltimatePainting()
    {
        ...
        // button icon.
        brushBut = makeMeButtons("G:\\PaintBrushIcon.png", 1);
        lineBut = makeMeButtons("G:\\LineIcon.png", 2);
        ellipseBut = makeMeButtons("G:\\CircleIcon.png", 3);
        rectBut = makeMeButtons("G:\\SquareIcon.png", 4);         
        
        // Make all the buttons in makeMeColorButton by passing the
        // button icon and true for stroke color or false for fill
        strokeBut = makeMeColorButton("G:\\StrokeColorIcon.png", 5, true);
        fillBut = makeMeColorButton("G:\\FillColorIcon.png", 6, false);
